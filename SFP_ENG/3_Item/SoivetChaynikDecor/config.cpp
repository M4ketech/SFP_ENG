...
class CfgVehicles
{
	...
	class Bottle_Base;
	class Pot;
	class SFP_Soviet_TeapotDecor: Pot
	{
		scope = 2;
		displayName = "Homemade Soviet Kettle";
		descriptionShort = "Soviet kettle. It will help you boil water on the fire or on the gas stove.";
		model = "\SFP\3_Item\SoivetChaynikDecor\soivetPotDecor.p3d";
		weight = 1240;
		itemSize[] = {4,3};
		itemsCargoSize[] = {4,4};
