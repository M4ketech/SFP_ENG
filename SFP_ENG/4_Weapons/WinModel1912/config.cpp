...
{
	class Mp133Shotgun;
	class SFP_WinM1912Shotgun_Base: Mp133Shotgun
	{
		scope = 0;
		absorbency = 0;
		...
		chamberSize = 6;
		chamberedRound = "";
		chamberableFrom[] = {"Ammo_12gaPellets","Ammo_12gaSlug","Ammo_12gaRubberSlug","Ammo_12gaBeanbag","Ammo_12gaPellets_tracer","Ammo_12gaNeedles"};
		magazines[] = {};
		DisplayMagazine = 0;
	...
	class SFP_WinM1912Shotgun: SFP_WinM1912Shotgun_Base
	{
		scope = 2;
		displayName = "Winchester Model 1912";
		descriptionShort = "The Winchester Model 1912 is a shotgun, developed by Winchester Repeating Arms Company engineer Thomas Crosley Johnson. Technically, it is a magazine rifle with manual reloading with the help of a rolling back - forward handguard (pump gun). Starting from the previous model M1897, the designer significantly reworked the whole design of the gun, changed the principle of locking, the receiver became closed, and the open trigger disappeared. From the old gun left only a few elements.";
		model = "\SFP\4_Weapons\WinModel1912\WM1912.p3d";
