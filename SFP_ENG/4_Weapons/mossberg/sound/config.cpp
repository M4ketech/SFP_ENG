...
class CfgSoundSets
{
	...
	class SFP_mossberg_Shot_SoundSet: Rifle_Shot_Base_SoundSet
	{
		soundShaders[] = {"SFP_mossberg_Shot_SoundShader"};
	};
};
class CfgSoundShaders
{
	class SFP_mossberg_Shot_SoundShader
	{
		samples[] = {{"SFP\4_Weapons\mossberg\sound\shot1",0.825},{"SFP\4_Weapons\mossberg\sound\shot2",0.825},{"SFP\4_Weapons\mossberg\sound\shot3",0.825}};
		volume = 1;
		range = 575;
	};
};
