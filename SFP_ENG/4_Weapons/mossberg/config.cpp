...
{
	class Mp133Shotgun;
	class SFP_Mossberg_ShotgunBase: Mp133Shotgun
	{
		scope = 0;
		absorbency = 0;
		...
		{
			soundSetShot[] = {"SFP_mossberg_Shot_SoundSet","Mp133_Tail_SoundSet","Mp133_InteriorTail_SoundSet"};
	...
	class SFP_Mossberg_Maverick: SFP_Mossberg_ShotgunBase
	{
		scope = 2;
		displayName = "Mossberg Maverick 88 Cruiser";
		descriptionShort = "Shotgun from the Mossberg Maverick series";
		model = "\SFP\4_Weapons\mossberg\mossberg.p3d";
