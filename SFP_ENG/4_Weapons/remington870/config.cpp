...
{
	class Mp133Shotgun;
	class SFP_Rem870_ShotgunBase: Mp133Shotgun
	{
		scope = 0;
		absorbency = 0;
	...
	class SFP_Rem870: SFP_Rem870_ShotgunBase
	{
		scope = 2;
		displayName = "Remington 870";
		descriptionShort = "Shotgun from the Remington Series";
		model = "\SFP\4_Weapons\remington870\Rem870.p3d";
