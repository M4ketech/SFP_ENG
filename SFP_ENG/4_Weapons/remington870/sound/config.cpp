...
class CfgSoundSets
{
	...
	class SFP_Rem870_Shot_SoundSet: Rifle_Shot_Base_SoundSet
	{
		soundShaders[] = {"SFP_Rem870_Shot_SoundShader"};
	};
};
class CfgSoundShaders
{
	class SFP_Rem870_Shot_SoundShader
	{
		samples[] = {{"SFP\4_Weapons\remington870\sound\Bah1",0.825},{"SFP\4_Weapons\remington870\sound\Bah2",0.825}};
		volume = 1;
		range = 575;
	};
};
