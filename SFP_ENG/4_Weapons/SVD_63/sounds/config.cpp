...
class CfgSoundSets
{
	...
	class SFP_SVD1963_Shot_SoundSet: Rifle_Shot_Base_SoundSet
	{
		soundShaders[] = {"SFP_SVD1963_Shot_SoundShader"};
	};
};
class CfgSoundShaders
{
	class SFP_SVD1963_Shot_SoundShader
	{
		samples[] = {{"SFP\4_Weapons\SVD_63\sounds\SVD_shot",0.825}};
		volume = 1.1;
		range = 575;
	};
};
