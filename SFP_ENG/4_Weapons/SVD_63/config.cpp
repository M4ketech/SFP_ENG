...
class CfgSlots
{
	class Slot_svd_dipload
	{
		name = "svd_dipload";
		displayName = "SVD Bipods";
		selection = "svd_dipload";
		ghostIcon = "bipod";
	};
	class Slot_svd_remen
	{
		name = "svd_remen";
		displayName = "SVD Belt";
		selection = "svd_remen";
		ghostIcon = "belt";
	};
};
class cfgWeapons
{
	...
	class SFP_SVD1963_Base: SVD
	{
		...
		{
			soundSetShot[] = {"SFP_SVD1963_Shot_SoundSet","SVD_Tail_SoundSet","SVD_InteriorTail_SoundSet"};
	...
	class SFP_SVD1963: SFP_SVD1963_Base
	{
		scope = 2;
		displayName = "SVD 1963";
		descriptionShort = "$STR_cfgWeapons_SVD1";
		model = "\SFP\4_Weapons\SVD_63\SVD1963.p3d";
		attachments[] = {"weaponWrap","weaponOpticsAK","weaponMuzzleAK","svd_remen","svd_dipload"};
		itemSize[] = {10,3};
		class DamageSystem
		{
			class GlobalHealth
...
class CfgNonAIVehicles
{
	...
	class Proxysvd_dipload: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "svd_dipload";
		model = "\SFP\4_Weapons\SVD_63\proxy\svd_dipload.p3d";
	};
	class Proxysvd_remen: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "svd_remen";
		model = "\SFP\4_Weapons\SVD_63\proxy\svd_remen.p3d";
	};
};
