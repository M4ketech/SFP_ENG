...
class CfgSoundSets
{
	...
	class SFP_UsStevens620_Shot_SoundSet: Rifle_Shot_Base_SoundSet
	{
		soundShaders[] = {"SFP_UsStevens620_Shot_SoundShader"};
	};
};
class CfgSoundShaders
{
	class SFP_UsStevens620_Shot_SoundShader
	{
		samples[] = {{"SFP\4_Weapons\us_stevens_620\sounds\Bah",0.125}};
		volume = 1;
		range = 475;
	};
};
