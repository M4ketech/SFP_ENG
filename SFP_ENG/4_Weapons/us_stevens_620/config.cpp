...
{
	class Mp133Shotgun;
	class SFP_Steven620_ShotgunBase: Mp133Shotgun
	{
		scope = 0;
		absorbency = 0;
		...
		{
			soundSetShot[] = {"SFP_UsStevens620_Shot_SoundSet","Mp133_Tail_SoundSet","Mp133_InteriorTail_SoundSet"};
	...
	class SFP_UsStevens620: SFP_Steven620_ShotgunBase
	{
		scope = 2;
		displayName = "U.S. Stevens mod. 620";
		descriptionShort = "American pump-action shotgun designed by John Browning.";
		model = "\SFP\4_Weapons\us_stevens_620\us_stevens.p3d";
