...
{
	class Mp133Shotgun;
	class SFP_Fabarm_ShotgunBase: Mp133Shotgun
	{
		scope = 0;
		absorbency = 0;
	...
	class SFP_Fabarm_shotgun: SFP_Fabarm_ShotgunBase
	{
		scope = 2;
		displayName = "Fabarm shotgun";
		descriptionShort = "A short shotgun that fits nicely anywhere.";
		model = "\SFP\4_Weapons\Mitchell_Wilson\Fabarm.p3d";
