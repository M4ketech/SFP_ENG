...
class CfgSoundSets
{
	...
	class SFP_Zombie_Shot_SoundSet: Rifle_Shot_Base_SoundSet
	{
		soundShaders[] = {"SFP_Zombie_Shot_SoundShader"};
	};
};
class CfgSoundShaders
{
	class SFP_Zombie_Shot_SoundShader
	{
		samples[] = {{"SFP\4_Weapons\Shorty\sounds\Bah1",0.125},{"SFP\4_Weapons\Shorty\sounds\Bah2",0.125},{"SFP\4_Weapons\Shorty\sounds\Bah3",0.125}};
		volume = 1;
		range = 475;
	};
};
