...
{
	class Mp133Shotgun;
	class SFP_Zombie_ShotgunBase: Mp133Shotgun
	{
		scope = 0;
		absorbency = 0;
		...
		{
			soundSetShot[] = {"SFP_Zombie_Shot_SoundSet","Mp133_Tail_SoundSet","Mp133_InteriorTail_SoundSet"};
	...
	class SFP_Zombie: SFP_Zombie_ShotgunBase
	{
		scope = 2;
		displayName = "Zombie killer";
		descriptionShort = "A short shotgun that fits nicely anywhere. Blows off a zombie head with ease.";
		model = "\SFP\4_Weapons\Shorty\shorty.p3d";
