...
class CfgVehicles
{
	...
	class SFP_Wild_Hourse: Animal_CervusElaphus
	{
		simulation = "dayzanimal";
		scope = 2;
		model = "\SFP\1_AI\hourse\Hours.p3d";
		displayName = "Wild horse";
		descriptionShort = "There are not many of them in the wild";
		...
		{
			useSpeedMapping = 1;
			movementSpeedMapping[] = {0,0.25,0.8,3.2,6,17};
		};
