...
class CfgVehicles
{
	class Rice;
	class Pumpkin;
	class SFP_Gigant_Otrezano_Head: Rice
	{
		scope = 2;
		displayName = "Pseudogigan's head";
		descriptionShort = "Head that may be of interest to scientists or other traders.";
		model = "\SFP\1_AI\Gigant\trofey\golova.p3d";
		weight = 2400;
		itemSize[] = {4,4};
		varQuantityInit = 300;
		varQuantityMin = 0;
	...
	class SFP_Gigant_Otrezano_Lapa: Rice
	{
		scope = 2;
		displayName = "Leg of the Pseudogigan";
	...
	class SFP_Gigant_Otrezano_kultapa: Rice
	{
		scope = 2;
		displayName = "Pseudogigan's Stump";
		descriptionShort = "A stump that may be of interest to scientists or other traders.";
		model = "\SFP\1_AI\Gigant\trofey\kultapa.p3d";
		weight = 700;
		itemSize[] = {1,3};
		varQuantityInit = 300;
		varQuantityMin = 0;
