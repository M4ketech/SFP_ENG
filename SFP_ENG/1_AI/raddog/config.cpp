...
{
	class AnimalBase;
	class SFP_RatDog_Base: AnimalBase
	{
		simulation = "dayzanimal";
		scope = 0;
		model = "\SFP\1_AI\raddog\ratdog2.p3d";
		displayName = "Ratwolf";
		descriptionShort = "Nasty biter!";
	...
	class SFP_RatDog_BIG: SFP_RatDog_Base
	{
		scope = 2;
	};
};
