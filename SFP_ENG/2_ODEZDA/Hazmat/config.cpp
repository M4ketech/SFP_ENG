...
class CfgVehicles
{
	...
	class NBCHoodGray;
	class NBCGlovesGray;
	class SFP_Hazmat_Boots: NBCBootsGray
	{
		scope = 2;
		displayName = "Protective environmentalist uniform boots (Lightweight)";
		descriptionShort = "The boots are from a special protective environmentalist uniform. This uniform was designed for assignments in especially dangerous places.";
		model = "SFP\2_ODEZDA\Hazmat\Haz_boots_g.p3d";
		inventorySlot[] = {"Feet"};
		...
		class ClothingTypes
		{
			male = "SFP\2_ODEZDA\Hazmat\Haz_boots.p3d";
			female = "SFP\2_ODEZDA\Hazmat\Haz_boots.p3d";
		};
		class DamageSystem
		{
			class GlobalHealth
	...
	class SFP_Hazmat_tors: NBCJacketGray
	{
		scope = 2;
		displayName = "Protective form of ecologists (Heavy)";
		descriptionShort = "Ecologist uniform. This form was developed to perform tasks in especially dangerous places. Usually this uniform is worn by people with extensive military experience.";
		model = "SFP\2_ODEZDA\Hazmat\Haz_tors_g.p3d";
		inventorySlot = "Body";
		...
		class ClothingTypes
		{
			male = "SFP\2_ODEZDA\Hazmat\Haz_tors.p3d";
			female = "SFP\2_ODEZDA\Hazmat\Haz_tors.p3d";
		};
		class AnimEvents
		{
			class SoundWeapon
	...
	class SFP_Hazmat_pants: NBCPantsGray
	{
		scope = 2;
		displayName = "Environmental Protection Pants (Heavy)";
		descriptionShort = "Pants of ecologists. This form was developed to perform tasks in especially dangerous places. Usually this uniform is worn by people with extensive military experience.";
		model = "SFP\2_ODEZDA\Hazmat\Haz_pants_g.p3d";
		inventorySlot = "Legs";
		simulation = "clothing";
		...
		class ClothingTypes
		{
			male = "SFP\2_ODEZDA\Hazmat\Haz_pants.p3d";
			female = "SFP\2_ODEZDA\Hazmat\Haz_pants.p3d";
		};
		class DamageSystem
		{
			class GlobalHealth
	...
	class SFP_Hazmat_Helm: NBCHoodGray
	{
		scope = 2;
		displayName = "Protective helmet for environmentalists (light)";
		descriptionShort = "environmentalist helmet. This form was developed to perform tasks in especially dangerous places. Usually this uniform is worn by people with extensive military experience.";
		model = "SFP\2_ODEZDA\Hazmat\Haz_head_g.p3d";
		...
		class ClothingTypes
		{
			male = "SFP\2_ODEZDA\Hazmat\Haz_head.p3d";
			female = "SFP\2_ODEZDA\Hazmat\Haz_head.p3d";
		};
		class AnimEvents
		{
			class SoundWeapon
